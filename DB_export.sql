...
CREATE TABLE `t_golfcoursehistory` (
  ...
  KEY `facebookID_fk_idx` (`userID`),
  CONSTRAINT `facebookID_fk` FOREIGN KEY (`userID`) REFERENCES `t_user` (`userID_pk`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `t_golfcoursehistory` VALUES (1,'1000-01-01 00:00:00',1,1,1),(2,'2013-02-02 00:00:00',2,1,2);
...
CREATE TABLE `t_scorehistory` (
  ...
  CONSTRAINT `fk_t_scoreHistory_t_golfCourseHistory1` FOREIGN KEY (`scoreHistory_pk`) REFERENCES `t_golfcoursehistory` (`golfCourseHistory_pk`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_scorehistory` VALUES (1,1,100,1),(2,2,72,1);
...
INSERT INTO `t_user` VALUES (1,'mgisoni'),(2,'someguy');
